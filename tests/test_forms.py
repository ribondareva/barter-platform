...
class ProposalFormTest(TestCase):
    def setUp(self):
        ...
        self.ad1 = Ad.objects.create(user=self.user1, title='A1', description='D1', category='Books', condition='new')
        self.ad2 = Ad.objects.create(user=self.user2, title='A2', description='D2', category='Toys', condition='used')
